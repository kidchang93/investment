...
| [`MANUAL.md`](./MANUAL.md) | 초보자용 **웹 화면** 사용 설명서. 화면 세 개(종목/내 계좌/발견) 안내, 안전 장치(게이트·리스크 룰·확인 단계), 주문 내는 법, 전략 판정 읽는 법, 확인된 값과 어림값 구분, 차단 문구 대처표. ★ **5장 「자동매매」는 폐기된 러너 이야기라 낡았다** — 지금 자동매매는 `OPERATIONS.md` |
