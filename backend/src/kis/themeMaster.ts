 ...
 *      2026-07-31 실측 **220종목**(쌍으로는 432/5,528).
 * 둘 다 DB에 남겨 화면이 "지금 반도체 테마"라고 거짓말하지 않게 한다.
 *
 * **2번은 종목 마스터를 새로 받을 때마다 늘어난다.** 테마 명단은 그대로인데 종목
 * 쪽만 새것이 되기 때문이다 — 2026-07-10~11자 종목 마스터로는 218종목(425쌍)이었고,
 * 20일 새 2026-07-30자로 바꾸자 220종목(432쌍)이 됐다. 더존비즈온(012510)·
 * 현대홈쇼핑(057050)이 그 20일 사이에 종목 마스터에서 빠진 예다.
 *
 * ETF에는 테마가 붙지 않는다 (2026-07-31 실측: 오늘자 마스터의 ETF 1,153종목 중
