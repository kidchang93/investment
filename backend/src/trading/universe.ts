 ...
 * 움직이든 똑같이 나간다. 하루 0.3% 움직이는 종목에서 왕복 0.41%가 나가면
 * 방향을 맞혀도 진다. 하루 변동폭의 절반을 넘게 비용으로 쓰는 종목은 뺀다.
 *
 * 2026-07-27 재측정에서 변동성 돌파가 out-of-sample 171회 매매에 비용
 * 14,735원 — 원금 49,751원의 29.6%를 썼다. 소액 계좌에서 비용은 전략을
 * 고르는 문제가 아니라 후보를 고르는 문제다.
 */
